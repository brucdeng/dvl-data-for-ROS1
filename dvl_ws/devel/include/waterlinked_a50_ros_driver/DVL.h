...
struct DVL_
{
  ...
  _altitude_type altitude;
   ...
   typedef std::vector< ::waterlinked_a50_ros_driver::DVLBeam_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::waterlinked_a50_ros_driver::DVLBeam_<ContainerAllocator> >> _beams_type;
  _beams_type beams;
  ...
  _status_type status;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _form_type;
  _form_type form;
...
struct Printer< ::waterlinked_a50_ros_driver::DVL_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::waterlinked_a50_ros_driver::DVL_<ContainerAllocator>& v)
  {
    ...
    s << indent << "form: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.form);
  }
};
